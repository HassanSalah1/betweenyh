...
@section('title', __('Manage') . ' ' . __('Roles'))
  ...
  <section>
    <div class="card">
      <div class="card-header">
        ...
        <a href="{{ route('roles.create') }}" class="btn btn-primary waves-effect waves-float waves-light">
          <i data-feather="plus"></i>
          <span>@lang('Create Role')</span>
        </a>
      </div>
